        ...
        <div className="container">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-[15px]">
              ...
              <a href="https://wa.me/971501508524" target="_blank" rel="noopener noreferrer" className="hidden sm:flex items-center gap-[8px] bg-[#25D366] hover:bg-[#128C7E] text-white px-[20px] py-[10px] rounded-full shadow-md font-bold text-[15px] transition-colors whitespace-nowrap">
